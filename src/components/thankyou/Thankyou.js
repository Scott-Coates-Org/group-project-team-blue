            ...
            <section className="d-flex flex-column align-items-center min-vh-100 h-100 checkout-bg p-3 overflow-auto pt-4 pb-4">
              ...
              >
                ...
                <Row className="mx-1">
                  ...
                  <p>
                    Please ensure that all hoppers fill out the waiver prior to arriving (you
                    can find the links below). Remember to arrive 10 minutes prior to your
                    booked time to allow time for check-in & to change into your awesome hopper
                    socks.
                  </p>
                </Row>
                ...
                <Row className="mx-1 mt-2">
                  <p>
                    Please remember that each participant must sign their waiver before coming
                    to Hopper.
                  </p>
                </Row>
                <Row className="mx-1 mt-4">
