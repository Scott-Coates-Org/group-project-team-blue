      ...
      <Container fluid="sm" id="waiverPDF" className="bg-white border p-sm-5 pt-3 pb-3">
        <div className="mb-5">
          ...
          <p>
            ...
            below (“Event”) and HEREBY ASSUME ALL OF THE RISKS OF PARTICIPATING AND/OR
            VOLUNTEERING IN THIS EVENT, including by way of example and not limitation, any
            risks that may arise from negligence, gross negligence, or carelessness on the part
            of the persons or entities being released or other participants or volunteers in
            the event, from dangerous or defective equipment or property owned, maintained, or
            controlled by them, or because of any of their possible liability without fault.
          </p>
          <p>
            ...
            condition or part of my employment, school curriculum, or otherwise. I acknowledge
            that this Event may carry with it the potential for death, serious injury, and
            property loss. I understand these risks are inherent to participants in the Event,
            including myself. I certify that there are no health-related reasons or problems
            that preclude my participation in this Event and that I have not been advised to
            not participate in this Event, or any other athletic activities, by any medical
            professional. I acknowledge that this Release will be used by the Event holders and
            organizers, and that it will govern my actions and responsibilities at the Event
            and that it will apply equally to any future {company} event in which I
            participate, whether I am required to sign an additional release for such future
            events or not.
          </p>
          <p>
            In consideration of my application and permitting me to participate in this Event,
            I hereby agree as follows for myself, my executors, administrators, and assigns
            (“Releasing Parties”) as follows:
          </p>
          <ol type="A">
            <li>
              I WAIVE, RELEASE, AND FOREVER DISCHARGE from any and all liability, including but
              not limited to, liability arising from the negligence or fault of the Released
              Parties, for my death, disability, personal injury, property damage, injuries
              from equipment or any other product used during the Event, property theft, torts
              of any kind, or actions of any kind which may occur to me during the Event (which
              shall include my traveling to and from this activity or event), THE FOLLOWING
              ENTITIES OR PERSONS:
            ...
            <li>
              ...
              the debtor," or any equivalent statute in my state of residence or in the state
              in which the Event is held.
            </li>
            <li>
              I INDEMNIFY, HOLD HARMLESS, AND PROMISE TO DEFEND the Released Parties from any
              and all liabilities or claims made as a result of my participation in this Event,
              whether caused by my negligence, intentional or negligent acts or omissions, or
              otherwise.
            </li>
          </ol>
          <p>
          ...
          <p>
            ...
            event of injury, accident, and/or illness during the Event (including during travel
            to and from the Event). For the sake of clarity, any decision or act by any
            Released Party to provide, request, or otherwise induce the provision of any
            medical treatment to me as a result of an injury, accident, or illness during the
            Event shall be covered by this Release.
          </p>
          <p>
            This Release shall be construed broadly to provide a release and waiver to the
            maximum extent permissible under applicable law. It shall be governed by {state}{" "}
            law.
          </p>
          <p>
            ...
            LIABILITY AND A CONTRACT THAT I AM AUTHORIZED AND COMPETENT TO SIGN IT ON BEHALF OF
            ALL RELEASING PARTIES, AND I SIGN IT OF MY OWN FREE WILL.
          </p>
        </div>
        <div>
          <FormGroup row>
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <p className="mt-4 mb-4">
              If Participant is under the age of majority, I herby certify that I am the parent
              / legal guardian of the above-named minor(s) and do hereby give permission for
              him/her/them to be present on the premises, to use the facilities, to receive
              instruction and to participate in the activities. I understand that this
              permission and release form shall be on file and shall be effective as long as
              the child is a minor or until we receive written request to terminate this
              permission.
            </p>
            <FormGroup row>
